...
import optsol from "../../images/optsol.png";
    ...
    <S.TimelineContent>
      ...
      <S.CustomVerticalTimeline>
        <VerticalTimelineElement
          ...
          icon={<S.EmpresaIcon src={optsol} />}
        >
          <h3 className="vertical-timeline-element-title">
            Engenheiro de Software Sênior
          </h3>
          <h4 className="vertical-timeline-element-subtitle">
            OPTSOL - Vila Velha, ES
          </h4>
          <p>
            Atuação em projetos terceirizados e produtos:
          </p>

          <S.List>
            <li>.NET Core e Angular</li>
            <li>.NET Core e React</li>
          </S.List>
        </VerticalTimelineElement>
        ...
        >
          ...
          <p>
            Atuação em diversos projetos da fábrica de software, onde as
            seguintes competências foram exercidas:
          </p>
        ...
        >
          ...
          <p>
            Atuação na sustentação de projetos da Petrobras, majoritariamente
            utilizando .NET com WebForms.
          </p>
        </VerticalTimelineElement>

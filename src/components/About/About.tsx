		...
		<S.AboutContent>
			...
			<S.DescriptionContainer color={Colors.branco}>
				...
				<p>
					...
					liderar uma equipe e desenvolver de apps utilizando <S.TextHighlight>React Native</S.TextHighlight>, SPAs com{" "}
					<S.TextHighlight>ReactJS</S.TextHighlight>, além do backend de aplicações construídas sob a plataforma <S.TextHighlight>.NET Core</S.TextHighlight>.
				</p>
